    ...
    <div class="form-container popup-form">
        ...
        <div class="button-container">
            <form action="deleteSupplier.php" method="GET">
                <a href="daftarproduk.php" type="submit" class="submit-button" name="submitDelete" style='text-decoration:none;text-align:center'>Yes</a>
                <a href="daftarproduk.php" type="button" class="cancel-button" style='text-decoration:none;text-align:center'>No</a>
            </form>
        </div>
    </div>
</body>
