...
<body>
    ...
    <div class="form-container popup-form">
        ...
        <div class="button-container">
            <form action="deleteKategori.php" method="GET">
                <a href="kategoriproduk.php" type="submit" class="submit-button" name="submitDelete" style='text-decoration:none;text-align:center'>Yes</a>
                <a href="kategoriproduk.php" type="button" class="cancel-button" style='text-decoration:none;text-align:center'>No</a>
            </form>
        </div>
    </div>
</body>
