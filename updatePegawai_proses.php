...
$id_peg_edit = $_POST['id'];

$pegawai = new Pegawai();
$result = ($pegawai)->updatePegawai($id_peg_edit, $edit_username, $edit_nama, $edit_password, $edit_role);
?>
...
<body>
    ...
    <div class="success-content popup-form">
        ...
        <a class="close-button" href="pegawai.php" style="text-decoration:none">OK</a>
    </div>
    </div>
</body>
