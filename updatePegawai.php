...
$row = (new Pegawai)->bacaDataById($id)->fetch_assoc();
?>
<!DOCTYPE html>
<html lang="en">
...
<body>
    ...
    <form class="form-container popup-form" method="POST" action="updatePegawai_proses.php">
        <span class="form-title">Edit Pegawai</span>
        <input type="text" placeholder="Username" required name="edit_username" value="<?php echo isset($row['username']) ? $row['username'] : ''; ?>">
        <input type="text" placeholder="Nama" required name="edit_nama" value="<?php echo isset($row['nama']) ? $row['nama'] : ''; ?>">
        <div class="password-container">
            <input type="password" placeholder="Password" required name="edit_password" id="passwordInput" value="<?php echo isset($row['password']) ? $row['password'] : ''; ?>">
        ...
        <select name="edit_role" required>
            ...
            <option value="pemilik" <?php echo isset($row['role']) && $row['role'] === 'pemilik' ? 'selected' : ''; ?>>Pemilik</option>
            <option value="karyawan" <?php echo isset($row['role']) && $row['role'] === 'karyawan' ? 'selected' : ''; ?>>Karyawan</option>
        </select>
